...
public class webConnector {
	...
	public webConnector(){
		...
		try{
			OR = new Properties();
			FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\resources\\com\\facebook\\property\\OR.properties");
			OR.load(fs);
		}catch(Exception e){
		...
		try{
			...
			FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\resources\\com\\facebook\\property\\Config.properties");
			Config.load(fs);
		}catch(Exception e){
			System.out.println("Error in initializing Properties file");
		}
	...
	public void openBrowser(String bType){
		if(Config.getProperty(bType).equals("firefox"))
